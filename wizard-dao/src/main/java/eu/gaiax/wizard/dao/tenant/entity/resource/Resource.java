package eu.gaiax.wizard.dao.tenant.entity.resource;
...
public class Resource extends SuperEntity {
    ...
    public String getTypeLabel() {
        return ResourceType.getByValue(type) != null ? ResourceType.getByValue(type).getLabel() : null;
    }
}
